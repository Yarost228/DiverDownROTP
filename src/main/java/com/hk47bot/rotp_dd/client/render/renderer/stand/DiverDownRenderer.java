...
public class DiverDownRenderer extends StandEntityRenderer<DiverDownEntity, DiverDownModel> {
    ...
    public DiverDownRenderer(EntityRendererManager renderManager) {
        super(renderManager,
                StandModelRegistry.registerModel(new ResourceLocation(RotpDiverDownAddon.MOD_ID, "diver_down"), DiverDownModel::new), new ResourceLocation(RotpDiverDownAddon.MOD_ID, "textures/entity/stand/diverdown.png"), 0);
    }
